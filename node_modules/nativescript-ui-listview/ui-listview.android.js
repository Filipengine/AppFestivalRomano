        ...
        if (this.isDataOperationsEnabled) {
            ...
            if (that_7.groupingFunction) {
                this._listViewAdapter.addGroupDescriptor(new com.telerik.android.common.Function({
                    apply: function (nativeItem) {
                        var index = that_7._listViewAdapter.getItems().indexOf(new java.lang.Integer(+nativeItem));
                        var item = that_7.getItemAtIndex(index);
            ...
            if (that_7.sortingFunction) {
                this._listViewAdapter.addSortDescriptor(new com.telerik.android.common.Function2({
                    apply: function (nativeItem1, nativeItem2) {
                        var nativeIndex1 = that_7._listViewAdapter.getItems().indexOf(new java.lang.Integer(+nativeItem1));
                        var nativeIndex2 = that_7._listViewAdapter.getItems().indexOf(new java.lang.Integer(+nativeItem2));
                        var item1 = that_7.getItemAtIndex(nativeIndex1);
                        var item2 = that_7.getItemAtIndex(nativeIndex2);
                        var javaRes = that_7.sortingFunction(item2, item1);
